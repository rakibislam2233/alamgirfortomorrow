  ...
  return (
    <section className="bg-white py-24 md:py-32 border-b border-black">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-px border border-black bg-black">
          <div className="lg:col-span-1 bg-white p-12 flex flex-col justify-center">
            ...
            <div className="space-y-6 bengali text-lg text-neutral-600">
              <div className="flex justify-between border-b border-neutral-100 pb-4">
                <span>মোট ইউনিয়ন</span>
                <span className="font-bold text-black text-2xl">২১টি</span>
              </div>
              <div className="flex justify-between border-b border-neutral-100 pb-4">
                <span>পৌরসভা</span>
                <span className="font-bold text-black text-2xl">১টি</span>
              </div>
              <div className="flex justify-between border-b border-neutral-100 pb-4">
                <span>মোট ভোটার</span>
          ...
          <div className="lg:col-span-2 bg-neutral-100 min-h-[500px] relative border-l border-black overflow-hidden">
            <iframe
