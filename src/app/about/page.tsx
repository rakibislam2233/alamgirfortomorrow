        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 gap-20 lg:grid-cols-12">
            <div className="lg:col-span-8">
              <p className="bengali mb-12 text-3xl font-light leading-relaxed text-neutral-800 md:text-4xl">
                “{SITE_DATA.about.content}”
              </p>

              <div className="space-y-16">
                <div>
                  <h2 className="bengali mb-8 text-4xl font-black tracking-tight italic">
                    শৈশব ও শিক্ষা
                  </h2>
                  <p className="bengali text-xl leading-relaxed text-neutral-600">
                ...
                <div>
                  <h2 className="bengali mb-12 text-4xl font-black tracking-tight italic">
                    রাজনৈতিক যাত্রার মাইলফলক
                  </h2>
                  <div className="space-y-8 border-l-4 border-black pl-12">
                    {SITE_DATA.about.fullBio?.milestones.map(
                      (milestone, idx) => (
                        <div key={idx}>
                          ...
                          <div className="bengali mt-2 text-2xl font-bold text-black">
                            {milestone.event}
                          </div>
                        </div>
                      ),
